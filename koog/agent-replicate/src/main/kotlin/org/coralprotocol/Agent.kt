...
data class ReplicateAgentSettings(
...
fun main() {
    runBlocking {
        val replicateSettings = loadAgentSettingsFromEnvironment<ReplicateAgentSettings>()
        ...
        val replicateToolRegistry = McpToolRegistryProvider.fromTransport(
            McpToolRegistryProvider.defaultStdioTransport(
                ProcessBuilder(
                    ...
                    environment()["REPLICATE_API_TOKEN"] = replicateSettings.replicateApiToken
                }.start()
            )
        )
        ...
        val toolRegistry = ToolRegistry {
            ...
            tools(replicateToolRegistry.tools)
        }
